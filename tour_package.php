				...
				<div class="row">
					<div class="col d-flex flex-row">
						...
						<div class="user_box ml-auto">
							<div class="user_box_login user_box_link"><a href="#"><i class="fa fa-sign-in"></i> login</a></div>
							<div class="user_box_register user_box_link"><a href="#"><i class="fa fa-user-plus"></i> register</a></div>
						</div>
					</div>
				</div>
			</div>		
