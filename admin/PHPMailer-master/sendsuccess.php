...
$booking->set('status',1); 
 ...
 $books = $booking->selectDataByIdd();
    ...
    echo $mailSub = "Booking Successful";
    echo $mailMsg = 'Dear '.$books[0]->customerName .' ,Your Booking for '.$books[0]->packageName.' package has been successful booked for the the date '.$books[0]->date.' <br><br><br><br>Regards, Sunshine Team';
...
$email = new PHPMailer(TRUE);
   ...
   if(!$mail->Send())
   {
       header("location:../booking_manage.php?confirm=1");
   }
   else
   {
       echo "Mail Sent";
